...
app.controller('ctrl',function($scope){
    ...
    var turingMachine = new TuringMachine("0");
    turingMachine.states[0] = new State();
    turingMachine.states[0].rules[0] = new Rule("0", 0, 0);
    turingMachine.states[0].rules[1] = new Rule("0", 0, 0);
    turingMachine.states[1] = new State();
    turingMachine.states[1].rules[0] = new Rule("1", 1, 1);
    turingMachine.states[1].rules[1] = new Rule("1", 1, 1);
    turingMachine.states[2] = new State();
    turingMachine.states[2].rules[0] = new Rule("1", 1, 1);
    turingMachine.states[2].rules[1] = new Rule("1", 1, 2);
    $scope.turingMachine = turingMachine;
    turingMachine.currentState = turingMachine.states[1];
